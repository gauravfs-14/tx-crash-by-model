...
export default function TrendsOverTimeSection({ data }: TrendsOverTimeSectionProps) {
      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto text-center">
            Vehicle crashes in Texas have shown distinct patterns over the years. The data reveals important insights
            about our changing roads and driving habits.
          </p>
        </motion.div>
        ...
        >
          <Card className="shadow-lg border-blue-100 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-50 to-white p-4 border-b border-blue-100">
              <h3 className="text-xl font-semibold text-slate-800">Annual Crash Incidents</h3>
              <p className="text-slate-500 text-sm">Total reported vehicle crashes by year</p>
            </div>
              ...
              <div className="h-[400px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                    ...
                    <XAxis dataKey="year" tick={{ fill: "#64748b" }} tickLine={{ stroke: "#cbd5e1" }} />
        ...
        >
          ...
          >
            ...
            <ul className="space-y-4 text-slate-700">
              <li className="flex items-start">
                ...
                <span>
                  Crash incidents peaked in 2019, with a slight decline in 2020 likely due to reduced traffic during the
                  pandemic.
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  The data shows a consistent upward trend from 2016 to 2019, reflecting increased vehicle ownership and
                  miles driven.
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>Seasonal patterns reveal higher crash rates during holiday periods and summer months.</span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-800">What This Means</h3>
            </div>
            <p className="text-slate-700 mb-4">
              The trend data suggests that despite advances in vehicle safety technology, the overall number of crashes
              has increased over time. This points to other factors at play, such as:
            </p>
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-center">
                <ArrowRight className="h-4 w-4 text-amber-500 mr-2 flex-shrink-0" />
                <span>Increased traffic density in urban areas</span>
              </li>
              <li className="flex items-center">
                <ArrowRight className="h-4 w-4 text-amber-500 mr-2 flex-shrink-0" />
                <span>Distracted driving due to mobile device usage</span>
              </li>
              <li className="flex items-center">
                <ArrowRight className="h-4 w-4 text-amber-500 mr-2 flex-shrink-0" />
                <span>Changing demographics of drivers on Texas roads</span>
              </li>
            </ul>
          </motion.div>
        </motion.div>
