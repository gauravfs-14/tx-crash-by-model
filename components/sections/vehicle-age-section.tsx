      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto text-center">
            Does the age of a vehicle correlate with its likelihood of being
            involved in a crash? The data reveals some surprising patterns about
        ...
        >
          ...
          <p className="text-slate-700 mb-6">
            Our analysis reveals a complex relationship between vehicle age and
            crash involvement. While newer vehicles (0-3 years old) appear
            frequently in crash statistics, this is partly due to their
            prevalence on the road. However, vehicles in the 5-8 year range show
            a concerning spike in crash rates.
          </p>
