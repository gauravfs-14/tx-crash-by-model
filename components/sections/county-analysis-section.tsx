...
export default function CountyAnalysisSection({
  data,
}: CountyAnalysisSectionProps) {
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
            Crash rates vary significantly across Texas counties. Discover which
            areas have the highest concentration of vehicle crashes.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-700 mb-4">
                Urban counties like Harris (Houston) and Dallas show the highest
                absolute crash numbers, driven by:
              </p>
              <ul className="space-y-2 text-slate-700">
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-cyan-500 mt-2 mr-2"></span>
                  <span>
                    Complex road systems with frequent merges and exits
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-cyan-500 mt-2 mr-2"></span>
                  <span>
                    Higher rates of distracted driving in congested areas
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-700 mb-4">
                While rural counties show lower absolute numbers, they often
                have higher crash rates per capita due to:
              </p>
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-teal-500 mt-2 mr-2"></span>
                  <span>
                    Less forgiving road environments (no shoulders, trees near
                    roadways)
                  </span>
                </li>
              </ul>
          ...
          <div className="mt-8 p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <p className="text-slate-700">
              Understanding geographic crash patterns helps transportation
              planners and policymakers target safety improvements where
              they&apos;re most needed. Urban areas benefit from congestion
              management and pedestrian safety measures, while rural areas need
              improved road design and faster emergency response capabilities.
            </p>
          </div>
        </motion.div>
      </div>
